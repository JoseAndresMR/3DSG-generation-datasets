...
![Overview](paper_images/front.pdf)
...
|---------|----------------|------------------|
| Synthetic (S) | Floor (F) | [S-F_comparison.png](comparison_images/S-F_comparison.png) |
| Synthetic (S) | Floor (F) Square | [S-F-square_comparison.png](comparison_images/S-F-square_comparison.png) |
| Synthetic (S) | City (C) | [S-C_comparison.png](comparison_images/S-C_comparison.png) |
| MSD (M) | Floor (F) | [M-F_comparison.png](comparison_images/M-F_comparison.png) |
| MSD (M) | Building (B) | [M-B_comparison.png](comparison_images/M-B_comparison.png) |
| MSD (M) | City (C) | [M-C_comparison.png](comparison_images/M-C_comparison.png) |
| Real LIDAR (R) | Floor (F) | [R-F_comparison.png](comparison_images/R-F_comparison.png) |
| Real LIDAR (R) | Building (B) | [R-B_comparison.png](comparison_images/R-B_comparison.png) |
| Real LIDAR (R) | City (C) | [R-C_comparison.png](comparison_images/R-C_comparison.png) |

## Our Approach

![Architecture](paper_images/architecture.pdf)
